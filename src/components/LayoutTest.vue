<template>
  <a-layout style="min-height: 100vh">
    <a-layout-header style="background: #f5f5f5; padding: 0; text-align: center;">Sparky</a-layout-header>
...
<script>
import { ref } from 'vue';
import { CommentOutlined, DollarOutlined, SettingOutlined, HistoryOutlined } from '@ant-design/icons-vue';
